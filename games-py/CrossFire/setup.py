...
METADATA = {
    ...
    'url':              'http://pyweek.org/e/CrossFire',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'CrossFire': 'CrossFire',
                   },
    'packages': ['CrossFire',
                ],
    'scripts': ['scripts/CrossFire'],
}
...
_DATA_DIR = os.path.join('CrossFire', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'CrossFire': data_dirs}
...
src = []
add_files(src,os.walk('CrossFire'))
